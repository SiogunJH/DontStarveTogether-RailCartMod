...
AddPrefabPostInit(
    ...
    function(inst)
        ...
        inst.railtrack_tool_iscavevoid = net_bool(inst.GUID, "railtrack_tool_iscavevoid", "railtrack_tool_iscavevoid")
        if TheWorld.ismastersim then
            ...
            inst.railtrack_tool_iscavevoid:set(false)
        else
        end
    end
)
...
AddGlobalClassPostConstruct(
    ...
    function()
        ...
        local Inv_Rebuild_old = Inv.Rebuild or function()
                return ""
            end
...
AddRecipe(
    "railtrack_cavevoid_item",
    {
        GLOBAL.Ingredient("boards", 1),
        GLOBAL.Ingredient("cutstone", 1),
        GLOBAL.Ingredient("batwing", 1)
    },
    GLOBAL.RECIPETABS.TOWN,
    GLOBAL.TECH.SCIENCE_TWO,
    nil, -- placer
...
GLOBAL.STRINGS.NAMES.RAILTRACK_CAVEVOID = L.RAILTRACK_CAVEVOID_NAME
GLOBAL.STRINGS.NAMES.RAILTRACK_CAVEVOID_ITEM = L.RAILTRACK_CAVEVOID_NAME
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_CAVEVOID = L.RAILTRACK_CAVEVOID_DESCRIBE
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_CAVEVOID_ITEM = L.RAILTRACK_CAVEVOID_ITEM_DESCRIBE
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_CAVEVOID_ITEM = L.RAILTRACK_CAVEVOID_ITEM_RECIPE
